...
canvas = tk.Canvas(root, width=800, height=660, bg="white")
canvas.pack()
...
button_frame.pack(side="left", padx=200, pady=20)  # วางไว้ด้านขวาของ root window
...
btn_bored = tk.Button(button_frame, text="bored face", command=draw_bored, width=10)
btn_bored.pack(side="top", pady=5)
